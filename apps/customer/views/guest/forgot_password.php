...
if (!empty($viewCollection) && $viewCollection->itemAt('renderContent')) {
    ...
    if (!empty($collection) && $collection->itemAt('renderForm')) {
        ...
        <div class="login-box-body">
            <p class="login-box-msg"><?php echo t('customers', 'Forgot password?'); ?></p>
            <?php
            /**
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="pull-left">
                        <a href="<?php echo createUrl('guest/index'); ?>" class="btn btn-flat btn-default"><?php echo IconHelper::make('prev') . '&nbsp;' . t('customers', 'Go to login'); ?></a>
                    </div>
