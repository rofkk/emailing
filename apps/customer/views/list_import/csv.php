...
<div class="box box-primary borderless">
    <div class="box-header">
        <div class="pull-left">
            <h3 class="box-title">
                <?php echo IconHelper::make('import') . t('list_import', 'CSV import progress'); ?> 
            </h3>
        </div>
    ...
    <div class="box-body" id="csv-import" data-model="<?php echo $import->getModelName(); ?>" data-pause="<?php echo (int)$pause; ?>" data-iframe="<?php echo createUrl('list_import/ping'); ?>" data-attributes='<?php echo json_encode($import->attributes); ?>'>
        <span class="counters">
