...
<li>
    <a href="<?php echo html_encode((string)$value['url']); ?>">
        <h5><?php echo html_encode((string)$value['heading']); ?> <small class="pull-right percentage"><?php echo html_encode((string)$value['percent']); ?>% <?php echo html_encode((string)$value['used']); ?>/<?php echo html_encode((string)$value['allowed']); ?></small></h5>
