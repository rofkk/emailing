...
class ListFieldBuilderTypeMultiselectSubscriber extends ListFieldBuilderTypeSubscriber
{
    ...
    protected function getValueModels(): array
    {
        ...
        foreach ($models as $model) {
            ...
            $defaultValue = !empty($model->default_value) ? array_map(['ListField', 'parseDefaultValueTags'], explode(',', $model->default_value)) : [];
    ...
    protected function buildFieldArrayMultiValues(array $models): array
    {
        ...
        return hooks()->applyFilters('list_field_builder_type_multiselect_subscriber_build_field_array', [
