...
class AccountController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if (request()->getIsPostRequest() && $attributes = request()->getPost($customer->getModelName())) {
    ...
    public function actionCompany()
    {
        ...
        if (request()->getIsPostRequest() && $attributes = request()->getPost($company->getModelName())) {
    ...
    public function renderTabs()
    {
        ...
        // since 1.3.6.2
        $tabs = hooks()->applyFilters('customer_account_edit_render_tabs', $tabs);
