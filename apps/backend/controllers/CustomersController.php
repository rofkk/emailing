...
class CustomersController extends Controller
{
    ...
    public function action2fa($id)
    {
        ...
        /** @var CustomerForTwoFactorAuth $customer */
    ...
    public function actionImpersonate($id)
    {
        ...
        // since 1.7.6
        $url = apps()->getAppUrl('customer', 'dashboard/index', true);
        $url = hooks()->applyFilters('redirect_url_after_impersonate_customer', $url, $customer);
        //
    ...
    public function _sendEmailNotification(CEvent $event)
    {
        ...
        if (!empty($sendWelcome) && !empty($sendWelcomeSubject) && !empty($sendWelcomeContent)) {
            ...
            $emailTemplate      = str_replace('[CONTENT]', $sendWelcomeContent, container()->get(OptionEmailTemplate::class)->common);
