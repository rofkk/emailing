    ...
    if (!empty($collection) && $collection->itemAt('renderForm')) {
        ...
        <div class="box box-primary borderless">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title"><?php echo IconHelper::make('fa-cog') . t('settings', 'Blacklist words'); ?></h3>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <?php echo $form->textField($model, 'notifications_to', $model->fieldDecorator->getHtmlOptions('notifications_to')); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <?php echo $form->textArea($model, 'subject', $model->fieldDecorator->getHtmlOptions('subject')); ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo t('settings', 'If you need to blacklist various words used in campaigns you can add them here. Please make sure you separate the words by a comma. If the word is matched, then the campaign will be blocked until you review and approve it.'); ?>
                    </div>
                </div>
            </div>
        </div>
