    ...
    if (!empty($collection) && $collection->itemAt('renderForm')) {
        ...
        <div class="box box-primary borderless">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title"><?php echo IconHelper::make('fa-cog') . t('settings', 'Exclude IPs from tracking'); ?></h3>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <?php echo $form->textArea($model, 'open', $model->fieldDecorator->getHtmlOptions('open')); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <?php echo $form->textArea($model, 'url', $model->fieldDecorator->getHtmlOptions('url')); ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo t('settings', 'If you need to exclude various IP addresses from open or url tracking, you can do it from here. Please make sure you separate the IP addresses with a comma.'); ?>
                    </div>
                </div>
            </div>
        </div>
