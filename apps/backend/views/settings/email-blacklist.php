...
$blacklistModel = $controller->getData('blacklistModel');
    ...
    if (!empty($collection) && $collection->itemAt('renderForm')) {
        ...
        <div class="box box-primary borderless">
            <div class="box-header">
                <h3 class="box-title"><?php echo IconHelper::make('fa-cog') . t('settings', 'Email blacklist settings'); ?></h3>
            </div>
            <div class="box-body">
                <?php
                /**
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <?php echo $form->dropDownList($blacklistModel, 'local_check', $blacklistModel->getYesNoOptions(), $blacklistModel->fieldDecorator->getHtmlOptions('local_check')); ?>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <?php echo $form->dropDownList($blacklistModel, 'allow_new_records', $blacklistModel->getYesNoOptions(), $blacklistModel->fieldDecorator->getHtmlOptions('allow_new_records')); ?>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <?php echo $form->dropDownList($blacklistModel, 'allow_md5', $blacklistModel->getYesNoOptions(), $blacklistModel->fieldDecorator->getHtmlOptions('allow_md5')); ?>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <?php echo $form->dropDownList($blacklistModel, 'reconfirm_blacklisted_subscribers_on_blacklist_delete', $blacklistModel->getYesNoOptions(), $blacklistModel->fieldDecorator->getHtmlOptions('reconfirm_blacklisted_subscribers_on_blacklist_delete')); ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <?php echo CHtml::link(IconHelper::make('info'), '#page-info-regex', ['class' => 'btn btn-primary btn-xs btn-flat', 'title' => t('app', 'Info'), 'data-toggle' => 'modal']); ?>
                            <?php echo $form->labelEx($blacklistModel, 'regular_expressions'); ?>
                            <?php echo $form->textArea($blacklistModel, 'regular_expressions', $blacklistModel->fieldDecorator->getHtmlOptions('regular_expressions', ['rows' => 10])); ?>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
	                            <?php echo $form->textField($blacklistModel, 'regex_test_email', $blacklistModel->fieldDecorator->getHtmlOptions('regex_test_email', [
                                        'name' => 'regex_test_email',
                                ])); ?>
                                <span class="input-group-btn">
                                    <button type="submit" href="javascript:;" class="btn btn-primary btn-flat"><?php echo t('settings', 'Test email(s)'); ?></button>
                                </span>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <?php echo t('settings', 'You can see a list of available DNSBL services by clicking {here}.', [
                                    '{here}' => '<a href="http://www.dnsbl.info/dnsbl-list.php" target="_blank">' . t('app', 'here') . '</a>',
                                ]); ?>
                                <br />
                                <?php echo t('settings', 'Please note, remote checks are usually slow and they will be even slower if you add many remote DNSBL services to check against.'); ?>
                            </div>
                        </div>
                    </div>
                </div>
