    ...
    if (!empty($collection) && $collection->itemAt('renderForm')) {
        ...
        <div class="box box-primary borderless">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title"><?php echo IconHelper::make('glyphicon-lock') . t('settings', '2FA settings'); ?></h3>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
			                ...
			                <?php echo $form->textField($model, 'companyName', $model->fieldDecorator->getHtmlOptions('companyName')); ?>
