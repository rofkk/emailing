    ...
    if (!empty($collection) && $collection->itemAt('renderForm')) {
        ...
        <div class="box box-primary borderless">
            <div class="box-header">
                <h3 class="box-title"><?php echo t('settings', 'Subaccounts'); ?></h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
			                <?php echo $form->labelEx($model, 'max_subaccounts'); ?>
			                <?php echo $form->numberField($model, 'max_subaccounts', $model->fieldDecorator->getHtmlOptions('max_subaccounts')); ?>
			                <?php echo $form->error($model, 'max_subaccounts'); ?>
                        </div>
                    </div>
                </div>
            </div>
