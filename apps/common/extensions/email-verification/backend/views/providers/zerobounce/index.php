    ...
    if (!empty($collection) && $collection->itemAt('renderForm')) {
        ...
        <div class="box box-primary borderless">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title"><?php echo $controller->t('Zerobounce'); ?></h3>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo $controller->t('{service} is a email validation service that helps detecting bad email addresses.', ['{service}' => '<a href="http://www.zerobounce.net" target="_blank">Zerobounce</a>']); ?><br />
                        <?php echo $controller->t('If you enable this extension, your customers will be able to use their own Zerobounce info for validating their own emails.'); ?><br />
                    </div>
                </div>
            </div>
        </div>
