...
class SearchExtBehaviorBounce_serversController extends SearchExtBaseBehavior
{
    /**
     * @return array
     */
    public function searchableActions(): array
    {
        return [
            'index' => [
                'keywords'          => ['bounce server', 'create bounce server', 'server', 'bounce'],
                'skip'              => [$this, '_skip'],
    ...
    public function _skip(SearchExtSearchItem $item): bool
    {
        if (MW_APP_NAME == 'customer') {
            ...
            if ((int)$customer->getGroupOption('servers.max_bounce_servers', 0) === 0) {
                return true;
            }
