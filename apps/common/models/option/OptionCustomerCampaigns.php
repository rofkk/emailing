...
class OptionCustomerCampaigns extends OptionBase
{
    ...
    {
        $rules = [
            ['max_campaigns, must_verify_sending_domain, can_delete_own_campaigns, max_bounce_rate, max_complaint_rate, can_export_stats, can_use_autoresponders, can_embed_images, can_use_timewarp, require_approval, abuse_reports_email_notification', 'required'],
            ['max_campaigns', 'numerical', 'integerOnly' => true, 'min' => -1],
            ['max_bounce_rate, max_complaint_rate', 'numerical', 'min' => -1, 'max' => 100],
            ['must_verify_sending_domain, can_delete_own_campaigns, can_export_stats, can_use_autoresponders, can_embed_images, can_use_timewarp, require_approval, abuse_reports_email_notification', 'in', 'range' => array_keys($this->getYesNoOptions())],
